...
export const HUBCLOUD_PORT = process.env.HUBCLOUD_PORT || '5000';   // ✅ FIXED: was '5001' (dead port!)
...
// Timer VPS (port 10000):   20-35s  → full 50s budget
// HubCloud VPS (port 5000): 15-30s  → full 50s budget
// Light scrapers (HBLinks, HubDrive, HubCDN): small pages → 20s is plenty
export const AXIOS_TIMEOUT_MS         = 50_000;  // VPS calls: full budget
export const AXIOS_SCRAPER_TIMEOUT_MS = 20_000;  // Light HTML scrapers: faster fail
...
export const SMART_RETRY_BACKOFF_MS  = 1000;  // ⚡ was 2000ms — faster retry
export const HTTP_522_MAX_RETRIES    = 2;
export const HTTP_522_BACKOFF_MS     = 1000;  // ⚡ was 2000ms — 1s/2s instead of 2s/4s
